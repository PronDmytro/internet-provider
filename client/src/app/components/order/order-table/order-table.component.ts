...
export class OrderTableComponent implements OnInit {
  ...
  @Input() public data: Order[] | undefined;

  public displayedColumns: string[] = ['id', 'client', 'contributor', 'date', 'service', 'workStatus', 'paymentStatus', 'btn'];
  // @ts-ignore
  ...
  public deleteData(data: Order) {

    this.apiRequestsService.deleteOrderData(data).subscribe({
      next: (response) => {
